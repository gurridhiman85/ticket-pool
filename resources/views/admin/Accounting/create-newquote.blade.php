    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <h5>To</h5>
                    <input name="ctl00$ctl00$Body$Body$txtTo" type="text" id="Body_Body_txtTo" class="form-control" placeholder="Search" style="width:100%;" />
                ...
                <div class="col-lg-3">
                    <h5>Date</h5>
                    <input name="ctl00$ctl00$Body$Body$txtIssueDate" type="date" value="2024-03-07" onchange="javascript:setTimeout(&#39;__doPostBack(\&#39;ctl00$ctl00$Body$Body$txtIssueDate\&#39;,\&#39;\&#39;)&#39;, 0)" onkeypress="if (WebForm_TextBoxKeyHandler(event) == false) return false;" id="Body_Body_txtIssueDate" class="form-control" required="required" />
                </div>
                <div class="col-lg-3">
                    <h5>Due Date</h5>
                    <input name="ctl00$ctl00$Body$Body$txtDueDate" type="date" value="2024-03-14" id="Body_Body_txtDueDate" class="form-control" required="required" style="width:100%;" />
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <input type="submit" name="ctl00$ctl00$Body$Body$btnSaveQuote" value="Save" onclick="HBAC(this);WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;ctl00$ctl00$Body$Body$btnSaveQuote&quot;, &quot;&quot;, true, &quot;&quot;, &quot;&quot;, false, false))" id="Body_Body_btnSaveQuote" class="btn btn-success" />
